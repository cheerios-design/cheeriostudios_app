...
export default function FeaturedProjects() {
  ...
  return (
    <section
      ...
      className="relative bg-gradient-to-b from-dark-bg to-dark-surface"
    >
                ...
                <div className="space-y-12">
                  {FEATURED_PROJECTS.map((project, index) => (
                    <div
                      ...
                      className={`transition-all duration-700 ease-out cursor-pointer group ${
                        index === activeIndex
                          ...
                          : "opacity-40 transform translate-x-4 hover:opacity-70"
                      }`}
                      onClick={() => {
                    ...
                    >
                      ...
                      <div className="mb-6">
                        <h3
                          className={`text-2xl md:text-3xl font-bold leading-tight transition-all duration-500 ${
                            index === activeIndex
                  ...
                  >
                    <div className="w-full">
                      ...
                      <div className="relative group">
                        <div className="aspect-[16/10] bg-dark-surface rounded-xl overflow-hidden shadow-2xl border border-white/10 hover:border-brand-primary/30 transition-all duration-500">
                          <Image
